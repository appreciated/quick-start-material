...
public class MaterialDesktopActionBar extends HorizontalLayout {
    ...
    private MenuBar contextButtons;
    private HorizontalLayout searchBarWrapper;
    private TextField searchBar;

    public MaterialDesktopActionBar() {
        Design.read(this);
    }
    ...
    public MenuBar getContextButtons() {
